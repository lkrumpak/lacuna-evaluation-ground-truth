...
( function ( scope ) {
    ...
    dijon.System.prototype = {
         ...
         * @return {dijon.System}
         */
        mapClass:function ( key, clazz ) {lacuna_lazy_load("js/lib/dijon-0.5.3.js[8368:8851]", functionData => eval(functionData))},
         ...
         * @return {Object}
         */
        instantiate:function ( key ) {lacuna_lazy_load("js/lib/dijon-0.5.3.js[10523:10702]", functionData => eval(functionData))},
         ...
         * @return {dijon.System}
         */
        unmap:function ( key ) {lacuna_lazy_load("js/lib/dijon-0.5.3.js[12637:12819]", functionData => eval(functionData))},
         ...
         */
        unmapOutlet:function ( target, outlet ) {lacuna_lazy_load("js/lib/dijon-0.5.3.js[13127:13430]", functionData => eval(functionData))},
         ...
         */
        unmapHandler:function ( eventName, key, handler ) {lacuna_lazy_load("js/lib/dijon-0.5.3.js[18549:19240]", functionData => eval(functionData))},
