  ...
  init: function (fn, history) {
    ...
    if ('onhashchange' in window && (document.documentMode === undefined
      ...
      if (this.history === true) {
        ...
        setTimeout(function() {lacuna_lazy_load("node_modules/director/build/director.js[1975:2026]", functionData => eval(functionData))}, 500);
      }
      else {
      ...
      if ('onpropertychange' in document && 'attachEvent' in document) {
        document.attachEvent('onpropertychange', function () {lacuna_lazy_load("node_modules/director/build/director.js[2549:2649]", functionData => eval(functionData))});
      }

      window.setInterval(function () {lacuna_lazy_load("node_modules/director/build/director.js[2698:2715]", functionData => eval(functionData))}, 50);
...
Router.prototype.insertEx = function(method, path, route, parent) {
  if (method === "once") {
    method = "on";
    route = function(route) {lacuna_lazy_load("node_modules/director/build/director.js[6722:6880]", functionData => eval(functionData))}(route);
  }
...
Router.prototype.invoke = function(fns, thisArg, callback) {
  ...
  var apply;
  if (this.async) {
    apply = function(fn, next) {lacuna_lazy_load("node_modules/director/build/director.js[13365:13568]", functionData => eval(functionData))};
    _asyncEverySeries(fns, apply, function() {lacuna_lazy_load("node_modules/director/build/director.js[13615:13696]", functionData => eval(functionData))});
  } else {
    apply = function(fn) {
      if (Array.isArray(fn)) {
...
Router.prototype.traverse = function(method, path, routes, regexp, filter) {
  ...
  function filterRoutes(routes) {
    ...
    function deepCopy(source) {lacuna_lazy_load("node_modules/director/build/director.js[14308:14495]", functionData => eval(functionData))}
    function applyFilter(fns) {lacuna_lazy_load("node_modules/director/build/director.js[14526:14840]", functionData => eval(functionData))}
