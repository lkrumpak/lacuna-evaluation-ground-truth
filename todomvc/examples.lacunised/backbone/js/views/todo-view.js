...
(function ($) {
	...
	app.TodoView = Backbone.View.extend({
		...
		edit: function () {lacuna_lazy_load("js/views/todo-view.js[2264:2326]", functionData => eval(functionData))},

		// Close the `"editing"` mode, saving changes to the todo.
		close: function () {lacuna_lazy_load("js/views/todo-view.js[2411:2909]", functionData => eval(functionData))},

		// If you hit `enter`, we're through editing the item.
		updateOnEnter: function (e) {lacuna_lazy_load("js/views/todo-view.js[2999:3059]", functionData => eval(functionData))},

		// If you're pressing `escape` we revert your change by simply leaving
		// the `editing` state.
		revertOnEscape: function (e) {lacuna_lazy_load("js/views/todo-view.js[3192:3378]", functionData => eval(functionData))},

		// Remove the item, destroy the model from *localStorage* and delete its view.
		clear: function () {lacuna_lazy_load("js/views/todo-view.js[3483:3513]", functionData => eval(functionData))}
	});
})(jQuery);
